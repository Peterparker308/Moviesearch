...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ Movie channel ⚡', url='https://t.me/bholaatw')
            ],
            [
                InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url=f"https://youtube.com/@gratexabcd"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://youtube.com/@gratexabcd'),
            InlineKeyboardButton('🤖 Movie channel 🤖', url='https://t.me/bholaatw')
            ],[
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🔥 JOIИ UᎮDΛTΞS CHΛИИΞL 🔥", url=("https://t.me/+ejpD6LYqsIRlZDg1")
                )
            ]
        ]
  ...
  [         InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/+ejpD6LYqsIRlZDg1') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
